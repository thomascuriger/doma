  ...
  <div class="map">
    ...
    <div class="info">
      ...
      <?php
        ...
        {
          $atoms[] = '<a target="_blank" href="'. $map->CreateResultListUrl() .'">' . __("RESULTS") .'</a>';
        }
        ...
        else
        {
          ...
          <div>
            <div class="comment shortComment">
              <img src="gfx/plus.png" id="togglecomment" class="toggleComment" alt="" />
              <div class="indent"><?php print $mapInfo["ContractedComment"]; ?></div>
            </div>
            <div class="comment longComment hidden">
              <img src="gfx/minus.png" id="togglecomment" class="toggleComment" alt="" />
