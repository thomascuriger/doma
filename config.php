<?php
  ...
  define('ADMIN_USERNAME', 'thomasc');
  define('ADMIN_PASSWORD', '960826');
  ...
  define('ADMIN_EMAIL', 'chef@thomascuriger.ch');
  ...
  define('_SITE_TITLE', 'DOMA Zurich Selection');

  // The name of the site as displayed in the browser's window title when browsing the user list page.
  define('_SITE_DESCRIPTION', 'Welcome to the digital orienteering map archive of the Zurich Selection!');
  ...
  define('LANGUAGES_AVAILABLE', 'Deutsch;de|English;en');
